...
import clientImage from '../../assests/Images/pool.jpg';
...
function LoginForm() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            let response;
            if (userType === 'client') {
                response = await fetch('http://10.255.64.46:5000/api/login', {
                    method: 'POST',
                    headers: {
                ...
                response = await fetch('http://10.255.64.46:5000/api/login-as-admin', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
